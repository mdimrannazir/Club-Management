...
$uid = $_SESSION['uid'];
$clubid = $_GET['clubid'];
// if(!isJoin($uid, $clubid)){
// echo "not joined result";
// }
...
<body>
    ...
    <div id=" carouselExampleIndicators" class="carousel slide">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/<?php echo'$club_title';?>.png">
            </div>
        </div>
    </div>
    <!-- SLIDER ends here -->
    ...
    <div class="container my-4" id="event">
        ...
        <div class="row">
            ...
            <?php
            $sql = "SELECT * FROM event where crecord =".$_GET['clubid'];
                    ...
                    echo '<div class="col-md-4">
                            <div class="card my-2" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul>
                                       <li class ="btnLogin buttonlinks"> <a href="">Join the event</a></li>
                                       
                                       <li class ="btnLogin buttonlinks"> <a href="event.php?eventid='.$row['evid'].'" >View the event</a> </li>
